...
$subjectPrefix = '[Chicago Airfreight Inquiry]';
...
$htmlMessage .= "
    ...
    <div class='footer'>
        <p>This inquiry was submitted via the Chicago Airfreight Landing Page</p>
...
$textMessage = "NEW AIRFREIGHT BOOKING INQUIRY - CHICAGO\n";
$textMessage .= "========================================\n\n";
$textMessage .= "Submitted: " . date('Y-m-d H:i:s') . "\n";
$textMessage .= "Source: Chicago Landing Page\n\n";
...
try {
    ...
    if (mail($adminEmail, $subject, $htmlMessage, implode("\r\n", $headers))) {
        ...
        echo json_encode([
            ...
            'booking_id' => 'CHI' . date('YmdHis') . strtoupper(substr(md5(uniqid()), 0, 6))
        ]);
    } else {
